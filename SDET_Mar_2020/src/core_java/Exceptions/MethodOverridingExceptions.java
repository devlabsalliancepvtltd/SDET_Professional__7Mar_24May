...
public class MethodOverridingExceptions
{
	public static void main(String[] args)
	{
		...
		Super obj = new Sub(); //runtime polymorphism
		try 
		{
			obj.show();
		} 
...
//------------------------------------------------------------------------------------------------------------------------------------------
//When super class method does not have any throws exception then we can add throws unchecked exception in subclass overridden method, not checked exception
//super : none 
 ...
 * 
 * class Sub extends Super { public void show() throws NullPointerException {
 * 
 * System.out.println("Sub class show() method"); } }
 */

//----------------------------------------------------------------------------------------------------------------------------------------------
    //When super class method does not have any throws exception then we can not add throw checked exception in subclass overridden method.
 ...
 */
//----------------------------------------------------------------------------------------------------------------------------------------------
    //When super class method throws checked exception then we can add throws same checked exception in subclass overridden method.
    //super IO, sub IO

/*
 * class Super { public void show() throws IOException{
 * System.out.println("Super class show() method"); } }
 * 
 * class Sub extends Super { public void show() throws IOException{
 * System.out.println("Sub class show() method");
 * 
 * } }
 */
...
/*
 * class Super {//parent or superclass
 * 
 ...
 * }}
 * 
 * class Sub extends Super { //child or subclass
 * 
